...
public class TestUtils {
     ...
     */
    public static AccountR createRandomAccount() {
        final AccountR account = new AccountR();
        account.setAcceptLanguage("en_US");
        //account.setAccountCode("111111");
        account.setAccountCode(UUID.randomUUID().toString());
        account.setCompanyName(getRandomAlphaNumString(10));
        account.setEmail(getRandomAlphaNumString(4) + "@vetapi.com");
        account.setFirstName(getRandomAlphaNumString(5));
        account.setLastName("api");
    ...
    public static Account createRandomAccount(Address address) {
        final Account account = new Account();
        account.setAcceptLanguage("en_US");
        //account.setAccountCode("VATest1");
        account.setAccountCode(UUID.randomUUID().toString());
        account.setCompanyName(getRandomAlphaNumString(10));
        account.setEmail(getRandomAlphaNumString(4) + "@vettest.com");
        account.setFirstName(getRandomAlphaNumString(5));
    ...
    public static AddressR createRandomAddress(){
        final AddressR address = new AddressR();
        address.setAddress1(UUID.randomUUID().toString());
        address.setAddress2(UUID.randomUUID().toString());
        address.setCity(UUID.randomUUID().toString());
        address.setState(UUID.randomUUID().toString());
     ...
     */
    public static BillingR createRandomBillingInfo() {
        final BillingR info = new BillingR();
