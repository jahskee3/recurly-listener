...
public class UpdateBillingInfo {
	...
	public static void updateBillingInfo(String memberId, BizManager bizManager, RecurlyClient client) throws RemoteException, VAException{
		...
		if(billingR!=null){
			...
			bizManager.updateCreditCard(memberId, ccInfo);
